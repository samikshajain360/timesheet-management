const AppDescription = () => {
  return (
    <div className="flex flex-col justify-center bg-[#1A56DB] h-full w-full px-[72px]">
      <h1 className="text-white text-[40px] font-semibold">ticktock</h1>
      <p className="text-gray-200 mt-3 text-[16px] font-normal">
